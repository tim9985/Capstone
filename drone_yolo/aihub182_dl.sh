...
# 이름:키 — 화성26(Val · 산악5 · 11 GB · 라벨 11,271장) → 의왕03(산악6 · 17 GB · 6,380장)
#   안산01(15 GB · 4,777장 · 평지(흙)2)은 뺐다 — GB당 장수 최저(318)이고 지형이 시흥_의왕_화성01 의
#   평지(흙)3(3,861장)과 겹친다. 라벨 전수 파싱 근거는 obsidian/02 데이터셋/AI-Hub 182 조난자 수색.md
JOBS="조난자_화성26:47867 조난자_의왕03:47905"
